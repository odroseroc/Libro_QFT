...
\begin{IEEEeqnarray*}{rCl}
	g\overline{q} \lambda^a q \gamma^\mu G_\mu &=& g \gamma^\mu \pmqty{q_1 & q_2 & q_3} \pmqty{0 & 0 & 1 \\ 0 & 0 & 0 \\ 1 & 0 & 0} \pmqty{q_1 \\ q_2 \\ q_3}G_\mu \slj
	%%
	&=& g \gamma^\mu G_\mu q_1 q_3 + \text{h. c.} \slj
	%%
	&=& g \gamma^\mu G_\mu q_1\lambda^a_{13}q_3 + \text{h. c.} \,,
\end{IEEEeqnarray*}
